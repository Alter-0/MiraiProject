...
// 后端接口
live2d_settings['modelAPI']             = 'http://localhost/MiraiProject/api/';   // 自建 API 修改这里
...
live2d_settings['homePageUrl']          = 'http://localhost/MiraiProject/main/main.php';       // 主页地址，可选 'auto'(自动), '{URL 网址}'
live2d_settings['aboutPageUrl']         = 'http://localhost/MiraiProject/main/main.php';   // 关于页地址, '{URL 网址}'
